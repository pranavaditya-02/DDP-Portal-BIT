...
router.post('/student-online-courses', upload.fields([
    ...
    try {
        ...
        const { student, yearOfStudy, specialLab, onlineCourse, courseType, marksAvailable, marksObtained, startDate, endDate, examDate, durationWeeks, partOfAcademic, semester, sponsorshipType, interdisciplinary, department, certificateUrl, iqacVerification, } = req.body;
        ...
        const [result] = await connection.query(`INSERT INTO student_online_courses (
          student_id,
          year_of_study,
          special_lab_id,
          online_course_id,
